...
const STRINGS = {
  en: {
    ...
    deleteEntryConfirm: (title) => `Delete the entry “${title}”?`,
    ...
    seedDeleteConfirm: (title) => `Delete the seed phrase “${title}”? Without the phrase the wallet cannot be recovered.`,
  ...
  sv: {
    ...
    deleteEntryConfirm: (title) => `Ta bort posten ”${title}”?`,
    ...
    seedDeleteConfirm: (title) => `Ta bort seed-frasen ”${title}”? Utan frasen kan plånboken inte återskapas.`,
